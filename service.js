/* service.js - ready-to-use
   - vehicle lookup (mock + proxy support)
   - injects compact issue dropdown (Annat first)
   - manages contact form submit UI (works with formsubmit.co)
   USAGE:
     - If you have a proxy endpoint set VEHICLE_API_URL to 'https://your-proxy.example.com/vehicle'
     - Deploy proxy (server.js included) and set provider env vars as described in README.md
*/

const VEHICLE_API_URL = null; // e.g. 'https://my-proxy.example.com/vehicle'
...
/* Contact form submit UI (keeps formsubmit.co) */
